...
Copy-Item -Path "$env:GITHUB_WORKSPACE/util/libavif-static-fix/libavif-config.cmake" -Destination "$env:VCPKG_ROOT/installed-$env:VCPKG_DEFAULT_TRIPLET/$env:VCPKG_DEFAULT_TRIPLET/share/libavif"
